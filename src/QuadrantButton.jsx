...
export default function QuadrantButton({ onSelect }) {
  return (
    <StyledWrapper>
      <div className="main">
        <div className="up">
          <button className="card1" onClick={() => onSelect('Training')}>
          ...
          <button className="card2" onClick={() => onSelect('Character')}>
        ...
        <div className="down">
          <button className="card3" onClick={() => onSelect('World')}>
          ...
          <button className="card4" onClick={() => onSelect('Friends')}>
